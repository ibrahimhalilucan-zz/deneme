...
<div class="panel panel-primary">
    <div class="panel-body"> 
        <form role="form" action="{{action('AdminController@menuduzenleme',$menu->id)}}" id="form1" method="post" class="validate" enctype="multipart/form-data">
            <div class="row">
                            ...
                            <div class="form-group"> 
                                ...
                                <div class="col-sm-10"> 
                                    <select name="sayfaturu" class="form-control select2" aria-invalid="false" > 
                                        <option value="anasayfa" {{ $menu->sayfaturu == 'anasayfa' ? 'selected="selected' : '' }}>Anasayfa</option> 
                                        <option value="referanslarimiz" {{ $menu->sayfaturu == 'referanslarimiz' ? 'selected="selected' : '' }}>Referanslarımız</option> 
                                        <option value="hakkimizda" {{ $menu->sayfaturu == 'hakkimizda' ? 'selected="selected' : '' }}>Hakkımızda</option>
                                        <option value="iletisim" {{ $menu->sayfaturu == 'iletisim' ? 'selected="selected' : '' }}>İletişim</option>
                                    </select> <br>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="adi" value="{{$menu->adi}}" data-validate="required" data-message-required="Boş Bırakılamaz." placeholder="Adı" /> </br>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Page Title<span class="span_need">*</span></label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="pagetitle" value="{{$menu->pagetitle}}" data-validate="required" data-message-required="Boş Bırakılamaz." placeholder="Page Title" /> </br>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Sırası<span class="span_need">*</span></label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="sirasi" value="{{$menu->sirasi}}" data-validate="number,required" data-message-required="Boş Bırakılamaz." placeholder="Sırası" /><br>
                                </div>
                            </div>                            
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Etiketleri</label>
                                <div class="col-sm-10"> 
                                    <input type="text" value="{{$menu->tags}}" name="tags" class="form-control tagsinput" />
                                </div>
                            </div>                           
                            <div class="form-group"> 
                                ...
                                <div class="col-sm-10">
                                    <div class="col-md-1">
                                        <div class="radio radio-replace color-blue" style="float: left;"> 
                                                <input type="radio" id="rd-1" name="durumu" value="Aktif" {{ $menu->durumu == 'Aktif' ? 'checked' : '' }}/>
                                                <label>Aktif</label><br/><br/>
                                        </div> 
                                    </div>
                                    <div class="col-md-1">
                                        <div class="radio radio-replace color-red" style="float: left;"> 
                                            <input type="radio" id="rd-2" name="durumu" value="Pasif" {{ $menu->durumu == 'Pasif' ? 'checked' : '' }}/>
