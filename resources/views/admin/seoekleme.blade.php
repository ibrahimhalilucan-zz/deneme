...
<div class="panel panel-primary">
    <div class="panel-body"> 
        <form role="form" action="{{action('AdminController@seoekleme')}}" id="form1" method="post" class="validate" enctype="multipart/form-data">
            <div class="row">
                    ...
                    <div class="tab-content"> 
                        <div class="tab-pane active" id="turkce">
                            ...
                            <div class="form-group"> 
                                ...
                                <div class="col-sm-10"> 
                                    <textarea class="form-control" id="field-ta" name="title" data-validate="required" data-message-required="Boş Bırakılamaz." placeholder="Title"></textarea><br>
                                </div> <br>
                            </div>
                            <div class="form-group"> 
                                <label for="field-ta" class="col-sm-2 control-label">Keywords<span class="span_need">*</span></label> 
                                <div class="col-sm-10"> 
                                    <textarea class="form-control" id="field-ta" name="keywords" data-validate="required" data-message-required="Boş Bırakılamaz." placeholder="Keywords"></textarea><br>
                                </div> <br>
                            </div>
                            <div class="form-group"> 
                                <label for="field-ta" class="col-sm-2 control-label">Description<span class="span_need">*</span></label> 
                                <div class="col-sm-10"> 
                                    <textarea class="form-control" id="field-ta" name="description" data-validate="required" data-message-required="Boş Bırakılamaz." placeholder="Description"></textarea><br>
                                </div> <br>
                            </div>
                            <div class="form-group"> 
                                <label for="field-ta" class="col-sm-2 control-label">Metatag<span class="span_need">*</span></label> 
                                <div class="col-sm-10"> 
                                    <textarea class="form-control" id="field-ta" name="metatag" data-validate="required" data-message-required="Boş Bırakılamaz." placeholder="Metatag"></textarea><br>
                                </div> <br>
                            </div>
                        </div>                        
                    </div> 
